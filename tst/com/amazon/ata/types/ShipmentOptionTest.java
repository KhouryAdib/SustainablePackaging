...
class ShipmentOptionTest {
    ...
    private Packaging packaging = new Box(BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE);
    ...
    private Packaging otherPackaging = new Box(BigDecimal.TEN, BigDecimal.TEN, BigDecimal.TEN);
